...
const Footer = () => {
  return (
    <div className='relative md:mt-20 md:pt-36 bg-[#051d42]'>
          <div className="absolute z-10 left-[0%] bottom-[0%] scale-105  translate-y-1/5 ">
            <img src="https://github.com/SyaidFarhan/Gamaftr/blob/main/405044-PDIA9G-992%201.png?raw=true" alt="" className="" /> </div>
  ...
  <img src="https://github.com/SyaidFarhan/Gamaftr/blob/main/Gamaft/resize/logo%20rev%20pake%20yg%20ini%20aja%20(1)%20(1).png?raw=true" alt="" className="max-w-[60px] md:max-w-[150px] md:pl-4 pl-1 ml-3" />
